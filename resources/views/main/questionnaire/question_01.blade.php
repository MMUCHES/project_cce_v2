...
<p>
<div class="bs-callout bs-line bs-callout-info">แบบสอบถามนี้มี 3 ตอน ตอนที่ 1 เป็นแบบสำรวจเจตคติของท่านที่ดีต่อวิชาชีพครูตอนที่ 2 เป็นแบบสำรวจความเชื่อ ความคิดเห็นและการกระทำของท่าน ตอนที่ 3 จะเป็นการแสดงความคิดเห็นอื่นๆจำนวนทั้งสิ้น 3 หน้าผลการสอบของท่านจะนำมาประมวลผลเป็นภาพรวมมิได้นำเสนอและเป็นรายบุคคลจึงขอให้ท่านออกความคิดเห็น ความเชื่อ และความรู้สึกที่เป็นจริงของท่านผู้เขียนขึ้น</div>
<div class="table-responsive">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <td>2.11</td>
            <td style="text-align: left">
                หากสิ่งทุกอย่างทำได้ผลต่างไปจากคนอื่นที่ทำในสิ่งเดียว การฉันจะยอมทดลองทำสิ่งนั้นซ้ำอีกเพื่อตรวจสอบให้แน่ใจถึงผลที่เกิดขึ้น
            </td>
